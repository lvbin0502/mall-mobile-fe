...
export function login(data) {
  return request.post("/sso/login", data, { login: false });
}
...
export function loginMobile(data) {
  return request.post("/sso/login/mobile", data, { login: false });
}
...
export function registerVerify(data) {
  return request.post("/sso/getAuthCode", data, { login: false });
}
...
export function register(data) {
  return request.post("/sso/register", data, { login: false });
}
...
export function registerReset(data) {
  return request.post("/sso/resetPwd", data, { login: false });
}
...
export function getCoupon(q) {
  return request.get("/coupon/list", q, { login: false });
}
...
export function getCouponsUser(type) {
  return request.get("/coupon/receivedList/" + type);
}
...
export function getCollectUser(page, limit) {
  return request.get("/user/collect/list", { page: page, limit: limit });
}
...
export function getCollectDel(id, category) {
  return request.post("/user/collect/del", { id: id, category: category });
}
...
export function postCollectAll(data) {
  return request.post("/user/collect/all", data);
}
...
export function getCollectAdd(id, category) {
  return request.post("/user/collect/add", { id: id, category: category });
}
