...
export function getCategory() {
  return request.get("/product/category", {}, { login: false });
}
...
export function getProducts(q) {
  return request.get("/product/search", q, { login: false });
}
...
export function getGroomList(type) {
  return request.get("/product/groom/" + type, {}, { login: false });
}
...
export function getSearchKeyword() {
  return request.get("/product/search/keyword", {}, { login: false });
}
